...
I created a shiny app that runs this calculation for a user-provided effective population size ($N_e$) and time ($t$). Visit this [link](https://kbrewer811.shinyapps.io/BIO435/?_ga=2.241502273.2108371051.1600992142-583861794.1588180640) to view the shiny app in full action with an animating graph.  